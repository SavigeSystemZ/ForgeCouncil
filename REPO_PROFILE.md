...
**Last scan (UTC):** 2026-04-04T19:40:06Z

## Summary

- **Product:** Forge Council — software-factory control plane.
- **Instruction files discovered:** 253

## Detected stack

| Stack | Marker | Suggested validation |
|-------|--------|----------------------|
...
| `.cursor/rules/fc-00-global.mdc` |
| `.cursor/rules/fc-10-architecture.mdc` |
| `.cursor/rules/fc-20-quality.mdc` |
| `.cursor/rules/fc-30-security.mdc` |
| `.cursor/rules/fc-40-handoffs.mdc` |
| `.cursor/rules/fc-50-precedence.mdc` |
| `.cursorrules` |
...
| `_system/forge-council/README.md` |
| `_system/forge-council/context/architecture_context.md` |
| `_system/forge-council/context/integration_context.md` |
| `_system/forge-council/context/product_context.md` |
| `_system/forge-council/context/quality_context.md` |
| `_system/forge-council/context/security_context.md` |
| `_system/forge-council/context/ux_context.md` |
| `_system/forge-council/policies/approval_policy.md` |
| `_system/forge-council/policies/escalation_policy.md` |
| `_system/forge-council/policies/export_policy.md` |
| `_system/forge-council/policies/memory_policy.md` |
| `_system/forge-council/policies/repo_precedence.md` |
| `_system/forge-council/policies/tool_policy.md` |
| `_system/forge-council/roles/boss.md` |
| `_system/forge-council/roles/builder_primary.md` |
| `_system/forge-council/roles/builder_secondary.md` |
| `_system/forge-council/roles/debugger_integrator.md` |
| `_system/forge-council/roles/planner.md` |
| `_system/forge-council/roles/planner_review.md` |
| `_system/forge-council/roles/reviewer_security.md` |
| `_system/forge-council/roles/tester.md` |
| `_system/forge-council/skills/blueprint_skill.md` |
| `_system/forge-council/skills/conflict_scan_skill.md` |
| `_system/forge-council/skills/eval_skill.md` |
| `_system/forge-council/skills/milestone_packet_skill.md` |
| `_system/forge-council/skills/prompt_export_skill.md` |
| `_system/forge-council/skills/repo_ingestion_skill.md` |
| `_system/forge-council/skills/resume_packet_skill.md` |
| `_system/forge-council/skills/review_gate_skill.md` |
| `_system/forge-council/skills/runtime_detection_skill.md` |
| `_system/forge-council/skills/test_gate_skill.md` |
| `_system/forge-council/templates/conflict_map.template.md` |
| `_system/forge-council/templates/decision_record.template.md` |
| `_system/forge-council/templates/milestone.template.md` |
| `_system/forge-council/templates/repo_profile.template.md` |
| `_system/forge-council/templates/resume_packet.template.md` |
| `_system/forge-council/templates/review_report.template.md` |
| `_system/forge-council/templates/task_packet.template.md` |
...
| `_system/prompt-packs/forge-council/M0.0-planning.md` |
| `_system/prompt-packs/forge-council/M0.1-canonical-docs.md` |
| `_system/prompt-packs/forge-council/M0.2-repo-local-layer.md` |
| `_system/prompt-packs/forge-council/M0.3-security-governance.md` |
| `_system/prompt-packs/forge-council/M0.4-independent-review.md` |
| `_system/prompt-packs/forge-council/M1.0-planning.md` |
| `_system/prompt-packs/forge-council/M1.1-repo-ingestion.md` |
| `_system/prompt-packs/forge-council/M1.2-tests.md` |
| `_system/prompt-packs/forge-council/M1.3-docs-polish.md` |
| `_system/prompt-packs/forge-council/M1.4-review.md` |
| `_system/prompt-packs/forge-council/M2.0-planning.md` |
| `_system/prompt-packs/forge-council/M2.1-blueprint-engine.md` |
| `_system/prompt-packs/forge-council/M2.2-tests.md` |
| `_system/prompt-packs/forge-council/M2.3-docs.md` |
| `_system/prompt-packs/forge-council/M2.4-review.md` |
...
| `python -m pytest` | Tests (if configured) |
| `python -m forge_council.schema_check` | FC schema validation |
